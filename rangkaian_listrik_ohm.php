...
<html lang="en">
    <head>
        ...
        <title> Rangkaian Listrik Ohm | Kelompok 2</title>
        <!-- Favicon-->
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
					...
					<a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="./rangkaian_listrik_ohm.php">RL Ohm</a>
					...
					<a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="./frekuensi_2.php">Frekuensi 2</a>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <!-- Card Form Rumus -->
					<div class="card mt-4">
						<div class="card-header">Rangkaian Listrik Ohm</div>
						<div class="card-body">
							<form>
								<div class="mb-3">
									<div class="row g-3 align-items-center">
										<div class="col-md-2">
											<label for="kuatarus" class="col-form-label">Kuat Arus</label>
										</div>
										<div class="col-md-6">
											<input type="number" id="kuatarus" class="form-control" aria-describedby="kuatarusHelpInline">
										</div>
										<div class="col-md-auto">
											<span id="kuatarusHelpInline" class="form-text">
												dalam satuan Ampere (I)
											</span>
										</div>
									</div>
								</div>
                                <div class="mb-3">
									<div class="row g-3 align-items-center">
										<div class="col-md-2">
											<label for="hambatan" class="col-form-label">Hambatan</label>
										</div>
										<div class="col-md-6">
											<input type="number" id="hambatan" class="form-control" aria-describedby="hambatanHelpInline">
										</div>
										<div class="col-md-auto">
											<span id="hambatanHelpInline" class="form-text">
												dalam satuan Ohm (R)
											</span>
										</div>
									</div>
								</div>
								<button type="button" id="submitRangkaianListrikOhm" class="btn btn-primary">Hitung</button>
							</form>
						</div>
					</div>
					<!-- End Card Form Rumus -->
					...
					<!-- Card Hasil -->
					<div class="card mt-3">
						<div class="card-header">Hasil Perhitungan Rangkaian Listrik Ohm </div>
						<div class="card-body">
							<h5 class="card-title" id="hasilrangkaianlistrikohm"></h5>
						</div>
					</div>
					<!-- End Card Hasil -->
                </div>
