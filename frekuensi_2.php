...
<html lang="en">
    <head>
        ...
        <title>Frekuensi 2 | Kelompok 2</title>
        <!-- Favicon-->
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <!-- Card Form Rumus -->
					<div class="card mt-4">
						<div class="card-header">Rumus Frekuensi 2</div>
						<div class="card-body">
							<form>
								<div class="mb-3">
									<div class="row g-3 align-items-center">
										<div class="col-md-2">
											<label for="kecepatan" class="col-form-label">Kecepatan Gelombang</label>
										</div>
										<div class="col-md-6">
								...
								<div class="mb-3">
									<div class="row g-3 align-items-center">
										<div class="col-md-2">
											<label for="panjang" class="col-form-label">Panjang Gelombang</label>
										</div>
										<div class="col-md-6">
											<input type="number" id="panjang" class="form-control" aria-describedby="panjangHelpInline">
										</div>
										<div class="col-md-auto">
											<span id="panjangHelpInline" class="form-text">
												(m)
											</span>
										</div>
									</div>
								</div>
								<button type="button" id="submitFrekuensi2" class="btn btn-primary">Hitung</button>
							</form>
						</div>
					</div>
					<!-- End Card Form Rumus -->
					...
					<div class="card mt-3">
						...
						<div class="card-body">
							<h5 class="card-title" id="hasilFrekuensi2"></h5>
						</div>
					</div>
					<!-- End Card Hasil -->
                </div>
