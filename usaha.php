        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
					...
					<a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="./usaha.php">Usaha</a>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
							...
							<form>
								<div class="mb-3">
									<div class="row g-3 align-items-center">
										<div class="col-md-2">
											<label for="gaya" class="col-form-label">Gaya</label>
										</div>
										<div class="col-md-6">
											<input type="number" id="gaya" class="form-control" aria-describedby="gayaHelpInline">
										</div>
								...
								<div class="mb-3">
									<div class="row g-3 align-items-center">
										<div class="col-md-2">
											<label for="perpindahan" class="col-form-label">Perpindahan</label>
										</div>
										<div class="col-md-6">
											<input type="number" id="perpindahan" class="form-control" aria-describedby="perpindahanHelpInline">
										</div>
										<div class="col-md-auto">
								...
								<button type="button" id="submitUsaha" class="btn btn-primary">Hitung</button>
							</form>
						</div>
					</div>
					<!-- End Card Form Rumus -->
					<!-- Card Hasil -->
					<div class="card mt-3">
						<div class="card-header">Hasil Perhitungan Usaha</div>
						<div class="card-body">
							<h5 class="card-title" id="hasilUsaha"></h5>
						</div>
					</div>
					<!-- End Card Hasil -->
                </div>
