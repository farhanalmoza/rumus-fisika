...
<html lang="en">
    <head>
        ...
        <title> Periode1 | Kelompok 2</title>
        <!-- Favicon-->
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="./periode1.php">Periode1</a>
                </div>
            </div>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <!-- Card Form Rumus -->
					<div class="card mt-4">
						<div class="card-header">Periode1</div>
						<div class="card-body">
							<form>
								<div class="mb-3">
                                ...
                                <div class="mb-3">
									<div class="row g-3 align-items-center">
										<div class="col-md-2">
											<label for="getaran" class="col-form-label">getaran</label>
										</div>
										<div class="col-md-6">
								...
								<button type="button" id="submitPeriode1" class="btn btn-primary">Hitung</button>
							</form>
						</div>
					</div>
					<!-- End Card Form Rumus -->
					...
					<!-- Card Hasil -->
					<div class="card mt-3">
						<div class="card-header">Hasil Perhitungan Periode1 </div>
						<div class="card-body">
							<h5 class="card-title" id="hasilPeriode1"></h5>
						</div>
					</div>
					<!-- End Card Hasil -->
                </div>
