...
<html lang="en">
    <head>
        ...
        <title>Hambatan Pengganti Seri | Kelompok 2</title>
        <!-- Favicon-->
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
					...
					<a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="./hambatanpenggantiseri.php">hambatanpenggantiseri</a>
                </div>
            </div>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                      <!-- Card Form Rumus -->
					<div class="card mt-4">
						<div class="card-header">hambatan pengganti seri</div>
						<div class="card-body">
							<form>
								<div class="mb-3">
								...
								<button type="button" id="hambatanpenggantiseri" class="btn btn-primary">Hitung</button>
							</form>
						</div>
					</div>
					<!-- End Card Form Rumus -->
					...
					<div class="card mt-3">
						<div class="card-header">Hambatan Pengganti Seri</div>
						<div class="card-body">
							<h5 class="card-title" id="hambatanpenggantiseri"></h5>
						</div>
					</div>
					<!-- End Card Hasil -->
