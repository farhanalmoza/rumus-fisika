        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
					...
					<a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="./daya.php">Daya</a>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <!-- Card Form Rumus -->
					<div class="card mt-4">
						<div class="card-header">Daya</div>
						<div class="card-body">
							<form>
								<div class="mb-3">
									<div class="row g-3 align-items-center">
										<div class="col-md-2">
											<label for="energi" class="col-form-label">Energi yang diserap</label>
										</div>
										<div class="col-md-6">
											<input type="number" id="energi" class="form-control" aria-describedby="energiHelpInline">
										</div>
										<div class="col-md-auto">
											<span id="energiHelpInline" class="form-text">
												(J)
											</span>
										</div>
									</div>
								...
								<button type="button" id="submitDaya" class="btn btn-primary">Hitung</button>
							</form>
						</div>
					</div>
					<!-- End Card Form Rumus -->
					<!-- Card Hasil -->
					<div class="card mt-3">
						<div class="card-header">Hasil Perhitungan Daya</div>
						<div class="card-body">
							<h5 class="card-title" id="hasilDaya"></h5>
						</div>
					</div>
					<!-- End Card Hasil -->
                </div>
