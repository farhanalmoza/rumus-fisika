        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="./rangkaian_listrik_ohm.php">rangkaian listrik ohm</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="./periode1.php">Periode1</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="./periode1.php">Periode2</a>
                </div>
            </div>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <!-- Card Form Rumus -->
					<div class="card mt-4">
						<div class="card-header">Periode2</div>
						<div class="card-body">
							<form>
								...
								<button type="button" id="submitPeriode2" class="btn btn-primary">Hitung</button>
							</form>
						</div>
					</div>
					<!-- End Card Form Rumus -->
					...
					<!-- Card Hasil -->
					<div class="card mt-3">
						<div class="card-header">Hasil Perhitungan Periode2 </div>
						<div class="card-body">
							<h5 class="card-title" id="hasilPeriode2"></h5>
						</div>
					</div>
					<!-- End Card Hasil -->
                </div>
