        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
					...
					<a class="list-group-item list-group-item-action list-group-item-light p-3" href="./kedalamanlaut.php">kedalamanlaut</a>
					<a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="./jarak.php">jarak</a>
                </div>
            </div>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                      <!-- Card Form Rumus -->
					<div class="card mt-4">
						<div class="card-header">jarak</div>
						<div class="card-body">
							<form>
								<div class="mb-3">
								...
								<button type="button" id="jarak" class="btn btn-primary">Hitung</button>
							</form>
						</div>
					</div>
					<!-- End Card Form Rumus -->
					...
					<div class="card mt-3">
						<div class="card-header">jarak</div>
						<div class="card-body">
							<h5 class="card-title" id="jarak"></h5>
						</div>
					</div>
					<!-- End Card Hasil -->
