...
<html lang="en">
    <head>
        ...
        <title>Energi Kinetik | Kelompok 2</title>
        <!-- Favicon-->
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
					...
					<a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="./energi_kinetik.php">Energi Kinetik</a>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <!-- Card Form Rumus -->
					<div class="card mt-4">
						<div class="card-header">Rumus Energi Kinetik</div>
						<div class="card-body">
							<form>
								<div class="mb-3">
								...
								<button type="button" id="submitEnergiKinetik" class="btn btn-primary">Hitung</button>
							</form>
						</div>
					</div>
					<!-- End Card Form Rumus -->
					...
					<!-- Card Hasil -->
					<div class="card mt-3">
						<div class="card-header">Hasil Perhitungan Energi Kinetik</div>
						<div class="card-body">
							<h5 class="card-title" id="hasilEnergiKinetik"></h5>
						</div>
					</div>
					<!-- End Card Hasil -->
                </div>
